            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-right">
                        ...
                        @if (Route::has('login'))
                            @auth
                            <a class="box" href="http://localhost:8080/laivanvo/public/user/{{Auth::user()->id}}">
                                {{Auth::user()->name}}
                            </a>
                ...
                <nav class="navigation-main clearfix">
                    ...
                    <div class="logo animated fadeIn">
                        <a href="index.html">
                            <img class="logo-desktop" src="images/airlines.png" alt="Alternate Text" />
                            <img class="logo-mobile" src="images/airlines2.png" alt="Alternate Text" />
                        </a>
                    </div>
                    ...
                    <div class="navigation-block clearfix">
                        ...
                        <ul class="navigation-left">
                            ...
                            <li>
                                <a href="#">Hang<span class="open-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                <ul>
                                    1
                ...
                <div class="footer-social">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-center">
                            <img src="https://data.vietnambooking.com/common/icon/home/icon_flight.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
