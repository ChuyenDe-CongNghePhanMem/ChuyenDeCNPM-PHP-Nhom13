  ...
  @endforeach
            ...
            <div id="item">
                ...
                <div id="customerDetail">
                    ...
                    <div id="customer_item">
                        <div id="ct1">
                            <div id="ct1_title">Childrent:</div>
                        </div>
                        <div id="ct2">
                    ...
                    <div id="customer_item">
                        <div class="radio-button">
                            ...
                            <label for="radio1">Economy</label>
                            <input type="radio" id="radio2" name="radios" value="false">
                            <label for="radio2">Deluxe Economy</label>
        ...
        <div id="right">
            <a href="https://www.icmarkets.com/global/fr/trading-markets/digitalcurrency"><img style="margin-left:7px;width: 255px" src="http://localhost:8080/laivanvo/public/images/coin.png"/></a>
            <a href="https://kfoodfair.vn/"><img style="margin-left:7px;width: 255px" src="http://localhost:8080/laivanvo/public/images/do_an.png"/></a>
        </div>
        {{-- <div id="detail">
